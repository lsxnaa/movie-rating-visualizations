...
plotly_treemap("director", p) %>%
  layout(
    ...
    margin=list(l=30, r=65, b=20, t=0),
  annotations=list(list(
    x=0, y=-0.035, xshift=3, showarrow = F, xref='paper', yref='paper',
    font=list(size=12, color="black"), text="Figure 3. Movies ratings grouped by star and director frequencies. There are 300 movies, 185 stars, and 200 directors."),
